...
\DoxyCodeLine{109   uint32\_t \mbox{\hyperlink{struct_a_r_m___m_p_u___region__t_ab5d3a650dbffd0b272bf7df5b140e8a8}{RLAR}};                   }
\DoxyCodeLine{110 \} \mbox{\hyperlink{struct_a_r_m___m_p_u___region__t}{ARM\_MPU\_Region\_t}};}
\DoxyCodeLine{111     }
\DoxyCodeLine{115 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} ARM\_MPU\_Enable(uint32\_t MPU\_Control)}
\DoxyCodeLine{116 \{}
...
\DoxyCodeLine{123 \}}
\DoxyCodeLine{124 }
\DoxyCodeLine{127 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} ARM\_MPU\_Disable(\textcolor{keywordtype}{void})}
\DoxyCodeLine{128 \{}
...
\DoxyCodeLine{141 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} ARM\_MPU\_Enable\_NS(uint32\_t MPU\_Control)}
\DoxyCodeLine{142 \{}
...
\DoxyCodeLine{149 \}}
\DoxyCodeLine{150 }
\DoxyCodeLine{153 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} ARM\_MPU\_Disable\_NS(\textcolor{keywordtype}{void})}
\DoxyCodeLine{154 \{}
...
\DoxyCodeLine{163 }
\DoxyCodeLine{169 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} ARM\_MPU\_SetMemAttrEx(MPU\_Type* mpu, uint8\_t idx, uint8\_t attr)}
\DoxyCodeLine{170 \{}
...
\DoxyCodeLine{180 \}}
\DoxyCodeLine{181 }
\DoxyCodeLine{186 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} ARM\_MPU\_SetMemAttr(uint8\_t idx, uint8\_t attr)}
\DoxyCodeLine{187 \{}
\DoxyCodeLine{188   ARM\_MPU\_SetMemAttrEx(MPU, idx, attr);}
\DoxyCodeLine{189 \}}
\DoxyCodeLine{190 }
\DoxyCodeLine{191 \textcolor{preprocessor}{\#ifdef MPU\_NS}}
\DoxyCodeLine{196 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} ARM\_MPU\_SetMemAttr\_NS(uint8\_t idx, uint8\_t attr)}
\DoxyCodeLine{197 \{}
\DoxyCodeLine{198   ARM\_MPU\_SetMemAttrEx(MPU\_NS, idx, attr);}
\DoxyCodeLine{199 \}}
\DoxyCodeLine{200 \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{201 }
\DoxyCodeLine{206 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} ARM\_MPU\_ClrRegionEx(MPU\_Type* mpu, uint32\_t rnr)}
\DoxyCodeLine{207 \{}
...
\DoxyCodeLine{216 \{}
\DoxyCodeLine{217   ARM\_MPU\_ClrRegionEx(MPU, rnr);}
\DoxyCodeLine{218 \}}
\DoxyCodeLine{219 }
\DoxyCodeLine{220 \textcolor{preprocessor}{\#ifdef MPU\_NS}}
\DoxyCodeLine{224 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} ARM\_MPU\_ClrRegion\_NS(uint32\_t rnr)}
\DoxyCodeLine{225 \{  }
\DoxyCodeLine{226   ARM\_MPU\_ClrRegionEx(MPU\_NS, rnr);}
\DoxyCodeLine{227 \}}
\DoxyCodeLine{228 \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{229 }
\DoxyCodeLine{236 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} ARM\_MPU\_SetRegionEx(MPU\_Type* mpu, uint32\_t rnr, uint32\_t rbar, uint32\_t rlar)}
\DoxyCodeLine{237 \{}
...
\DoxyCodeLine{241 \}}
\DoxyCodeLine{242 }
\DoxyCodeLine{248 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} ARM\_MPU\_SetRegion(uint32\_t rnr, uint32\_t rbar, uint32\_t rlar)}
\DoxyCodeLine{249 \{}
\DoxyCodeLine{250   ARM\_MPU\_SetRegionEx(MPU, rnr, rbar, rlar);}
\DoxyCodeLine{251 \}}
\DoxyCodeLine{252 }
\DoxyCodeLine{253 \textcolor{preprocessor}{\#ifdef MPU\_NS}}
\DoxyCodeLine{259 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} ARM\_MPU\_SetRegion\_NS(uint32\_t rnr, uint32\_t rbar, uint32\_t rlar)}
\DoxyCodeLine{260 \{}
\DoxyCodeLine{261   ARM\_MPU\_SetRegionEx(MPU\_NS, rnr, rbar, rlar);  }
\DoxyCodeLine{262 \}}
\DoxyCodeLine{263 \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{264 }
\DoxyCodeLine{270 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} orderedCpy(\textcolor{keyword}{volatile} uint32\_t* dst, \textcolor{keyword}{const} uint32\_t* \_\_RESTRICT src, uint32\_t len)}
\DoxyCodeLine{271 \{}
...
\DoxyCodeLine{277 \}}
\DoxyCodeLine{278 }
\DoxyCodeLine{285 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} ARM\_MPU\_LoadEx(MPU\_Type* mpu, uint32\_t rnr, \mbox{\hyperlink{struct_a_r_m___m_p_u___region__t}{ARM\_MPU\_Region\_t}} \textcolor{keyword}{const}* table, uint32\_t cnt) }
\DoxyCodeLine{286 \{}
...
\DoxyCodeLine{290     orderedCpy(\&(mpu-\/>RBAR), \&(table-\/>\mbox{\hyperlink{struct_a_r_m___m_p_u___region__t_afe7a7721aa08988d915670efa432cdd2}{RBAR}}), rowWordSize);}
...
\DoxyCodeLine{298       orderedCpy(\&(mpu-\/>RBAR)+(rnrOffset*2U), \&(table-\/>\mbox{\hyperlink{struct_a_r_m___m_p_u___region__t_afe7a7721aa08988d915670efa432cdd2}{RBAR}}), c*rowWordSize);}
...
\DoxyCodeLine{304     \}}
\DoxyCodeLine{305     }
\DoxyCodeLine{306     orderedCpy(\&(mpu-\/>RBAR)+(rnrOffset*2U), \&(table-\/>\mbox{\hyperlink{struct_a_r_m___m_p_u___region__t_afe7a7721aa08988d915670efa432cdd2}{RBAR}}), cnt*rowWordSize);}
\DoxyCodeLine{307   \}}
\DoxyCodeLine{308 \}}
\DoxyCodeLine{309 }
\DoxyCodeLine{315 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} ARM\_MPU\_Load(uint32\_t rnr, \mbox{\hyperlink{struct_a_r_m___m_p_u___region__t}{ARM\_MPU\_Region\_t}} \textcolor{keyword}{const}* table, uint32\_t cnt) }
\DoxyCodeLine{316 \{}
\DoxyCodeLine{317   ARM\_MPU\_LoadEx(MPU, rnr, table, cnt);}
\DoxyCodeLine{318 \}}
\DoxyCodeLine{319 }
\DoxyCodeLine{320 \textcolor{preprocessor}{\#ifdef MPU\_NS}}
\DoxyCodeLine{326 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} ARM\_MPU\_Load\_NS(uint32\_t rnr, \mbox{\hyperlink{struct_a_r_m___m_p_u___region__t}{ARM\_MPU\_Region\_t}} \textcolor{keyword}{const}* table, uint32\_t cnt) }
\DoxyCodeLine{327 \{}
\DoxyCodeLine{328   ARM\_MPU\_LoadEx(MPU\_NS, rnr, table, cnt);}
\DoxyCodeLine{329 \}}
